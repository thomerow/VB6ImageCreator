...
Because I already had a large icon collection which solely consists of 32 bit argb PNG images I came up with this little program to have a possibility to convert those existing images automatically.
